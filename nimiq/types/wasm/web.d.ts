...
export interface InitOutput {
  ...
  readonly closure1749_externref_shim: (a: number, b: number, c: any) => void;
  readonly _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h57a3662dbb3c4669: (a: number, b: number) => void;
  readonly _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hc72e56d240b9010b: (a: number, b: number) => void;
  readonly closure2388_externref_shim: (a: number, b: number, c: any) => void;
  readonly closure2733_externref_shim: (a: number, b: number, c: any) => void;
  readonly closure2922_externref_shim: (a: number, b: number, c: any, d: any) => void;
