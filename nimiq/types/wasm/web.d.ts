...
export interface InitOutput {
  ...
  readonly closure600_externref_shim: (a: number, b: number, c: any) => void;
  readonly closure598_externref_shim: (a: number, b: number, c: any) => void;
  readonly closure1758_externref_shim: (a: number, b: number, c: any) => void;
  readonly _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h7d9ac25d3040b495: (a: number, b: number) => void;
  readonly _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h9115a194ee36ae28: (a: number, b: number) => void;
  readonly closure2397_externref_shim: (a: number, b: number, c: any) => void;
  readonly closure2754_externref_shim: (a: number, b: number, c: any) => void;
  readonly closure2942_externref_shim: (a: number, b: number, c: any, d: any) => void;
